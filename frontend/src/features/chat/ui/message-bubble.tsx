        ...
        <div className="flex flex-col max-w-[85%] sm:max-w-[70%] min-w-0">
          ...
          >
            {message.replyTo && (
              <div
                className={cn(
                  "mb-1.5 px-2 py-1 border-l-2 rounded bg-black/5 dark:bg-white/5 cursor-pointer opacity-80",
              ...
              >
                ...
                <p className="text-[12px] truncate opacity-90">
                  {displayReplyText}
                </p>
              </div>
            )}

            <span className="block whitespace-pre-wrap break-all [word-break:break-word] [overflow-wrap:anywhere]">
              {displayText}
            </span>
